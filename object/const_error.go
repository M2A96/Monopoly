...
var (
	...
	ErrGameServiceReadList                 = errors.New("failed to game service read game")
	ErrGameStateServiceGetCurrentState     = errors.New("failed to game state service get current game state")
	ErrGameStateServiceGetGameStateHistory = errors.New("failed to game state service get game state history")
	...
	ErrGameStateServiceSaveGameState = errors.New("failed to save game state")
